...
import com.whomentors.aqua.Recievers.Boot
import com.whomentors.aqua.Recievers.Notifier
import java.util.concurrent.TimeUnit

class Alarm {
    private var alarmManager: AlarmManager? = null

    private val ACTION_BD_NOTIFICATION = "com.ownapps.waterreminder.NOTIFICATION"
    ...
    fun setAlarm(context: Context, notificationFrequency: Long) {
        ...
        /* Restart if rebooted */
        val receiver = ComponentName(context, Boot::class.java)
